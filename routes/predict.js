// routes/predict.js (ESM) — improved version
import express from "express";
import { predict } from "../ml.js"; // make sure ml.js exports this

const router = express.Router();

router.post("/", async (req, res) => {
  try {
    // parse and coerce to numbers (protects against string inputs)
    ...
    // Call predict — support sync or async implementations
    ...
    // clamp & round probability to 2 decimals
